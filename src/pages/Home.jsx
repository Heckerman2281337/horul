...
export default function Home() {
    return (
        <>
            <Container className="text-center py-5 mt-2">

                <h1 className="display-3 mb-5 fw-bold" style={{ letterSpacing: '0.07em' }}>Хорул</h1>

                <p className="lead text-muted mx-auto mb-4 fs-3 fs-md-1" style={{ maxWidth: '600px' }}>
                ...
                <p className="lead text-muted mx-auto mb-4 fs-3 fs-md-1" style={{ maxWidth: '500px' }}>
